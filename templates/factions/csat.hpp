...
#define LEAD_HELMETS {"H_MilCap_ocamo","H_Beret_blk"}
#define CREW_HELMETS {"H_HelmetCrew_O"}
#define HELI_HELMETS {"H_PilotHelmetHeli_O"}
#define HELI_CREW_HELMETS {"H_CrewHelmetHeli_O"}

#define STD_UNIFORMS {"U_O_CombatUniform_ocamo"}
#define LEAD_UNIFORMS {"U_O_OfficerUniform_ocamo"}
...
#define TAC_VEST {"V_TacVest_khk"}
#define LIGHT_VESTS TAC_VEST
#define STD_VESTS {"V_HarnessO_brn"}
#define GL_VESTS {"V_HarnessOGL_brn"}
#define HEAVY_VESTS STD_VESTS
...
#define NV {O_NV}
#define PDA {"o_EasyTrack_PDA"}
#define TABLET {"o_EasyTrack_Tablet"}
